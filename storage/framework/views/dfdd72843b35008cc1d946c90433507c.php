<?php $__env->startSection('content'); ?>
    <div class="container d-flex flex-row h-100">
        ...
        <form action="<?php echo e(route('rekap.validasi', $rekap->id)); ?>" method="POST" enctype="multipart/form-data"
            ...
            <!-- Tombol Submit -->
            <button type="submit"
                style="width: 100%; height: 40px; background-color: #4CAF50; color: #fff; padding: 10px; border: none; border-radius: 5px; cursor: pointer;">
                <?php echo e($rekap->id ? 'Validasi' : 'Simpan'); ?>
