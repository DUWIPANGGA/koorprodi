...
<aside class="sidebar" id="sidebar">
    <div class="h-full flex flex-col bg-white shadow-md">
        ...
        <div class="sidebar-header p-4 border-b border-gray-100">
            <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-brand flex items-center space-x-3">
                <img src="<?php echo e(asset('formadiksi.png')); ?>" alt="FORMADIKSI Logo" class="h-10 w-auto">
        ...
        <div class="flex-1 overflow-y-auto">
            <nav class="sidebar-menu p-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="<?php echo e(route('domisili.index')); ?>" class="nav-link flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('domisili.index') ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:bg-gray-50 hover:text-black'); ?>">
                            <i class="fas fa-home mr-3 w-5 text-center"></i>
                            <span>Domisili</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(route('sktm.index')); ?>" class="nav-link flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('sktm.index') ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:bg-gray-50 hover:text-black'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('redirect-links.index')); ?>" class="nav-link flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('redirect-links.index') ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:bg-gray-50 hover:text-black'); ?>">
                ...
                <div class="mt-8 pt-4 border-t border-gray-100">
                    <ul class="space-y-1">
                        <li>
                            <a href="<?php echo e(route('profile.edit', Auth::user()->id)); ?>" class="nav-link flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('profile.edit') ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:bg-gray-50 hover:text-black'); ?>">
                        ...
                        <li>
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                <?php echo csrf_field(); ?>
                                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="nav-link flex items-center p-3 rounded-lg transition-colors text-gray-500 hover:bg-gray-50 hover:text-black">
