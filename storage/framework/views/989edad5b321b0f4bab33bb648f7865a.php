        ...
        <div class="hidden md:block md:w-1/2 lg:w-2/3 relative">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                ...
                <div class="mb-8 transition-transform duration-300 hover:scale-105" data-aos="fade-up" data-aos-duration="800">
                    <img src="<?php echo e(asset('formadiksi.png')); ?>" alt="Formadiksi Logo" class="w-48 h-auto mx-auto drop-shadow-lg">
                </div>
...
</html><?php /**PATH D:\KULIAH\UKM\formadiksi\koorprodi-web\koorprodi\resources\views/login.blade.php ENDPATH**/ ?>