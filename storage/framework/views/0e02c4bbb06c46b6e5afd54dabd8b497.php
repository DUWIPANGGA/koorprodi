...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6 flex flex-col md:flex-row items-center gap-6">
            <div class="relative">
                <img src="<?php echo e(Auth::user()->foto_profil ?? asset('LogoOrang.jpg')); ?>" alt="Foto profil"
            ...
            <div class="flex-1">
                <h1 class="text-xl md:text-2xl font-bold text-gray-800">Selamat datang kembali, <?php echo e(Auth::user()->name); ?>!
                </h1>
                ...
                <div class="flex gap-4 mt-4">
                    ...
                    <a href="<?php echo e(route('rekap')); ?>" class="text-gray-600 hover:text-gray-800 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-4">
            ...
            <p class="mt-2 text-xs text-gray-500">Semester <?php echo e($ipkNew->semester ?? 1); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-4">
            ...
            <p class="mt-1 text-2xl font-bold text-gray-900"><?php echo e(Auth::user()->semester ?? 1); ?></p>
            <p class="mt-1 text-xs text-gray-500">Anda berada di semester <?php echo e(Auth::user()->semester); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-4">
            ...
            <p class="mt-1 text-2xl font-bold text-gray-900"><?php echo e($ipkNew->IPK ?? 0); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <!-- Top Section - Icon -->
        <div class="<?php echo e(Auth::user()->pelaporan_ipk == 1 ? 'bg-teal-50' : 'bg-amber-50'); ?> p-4 flex justify-center">
            <div class="<?php echo e(Auth::user()->pelaporan_ipk == 1 ? 'bg-teal-100' : 'bg-amber-100'); ?> p-3 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 <?php echo e(Auth::user()->pelaporan_ipk == 1 ? 'text-teal-600' : 'text-amber-600'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <!-- Aspirasi -->
                <a href="<?php echo e(route('rumah-aspirasi.create')); ?>"
                    class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                ...
                <!-- Domisili -->
                <a href="<?php echo e(route('domisili.index')); ?>"
                    class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                ...
                <!-- SKTM -->
                <a href="<?php echo e(route('sktm.create')); ?>"
                    class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
        ...
        <?php if(Auth::user()->role == 'admin' || Auth::user()->role == 'super_admin'): ?>
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <!-- Data IPK -->
                    <a href="<?php echo e(route('Rekap.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                    ...
                    <a href="<?php echo e(route('redirect-links.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                        <div class="bg-blue-100 p-3 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.sktm.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                    ...
                    <a href="<?php echo e(route('admin.domisili.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                        <div class="bg-purple-100 p-3 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php if(Auth::user()->role == 'KOMINFO' || Auth::user()->role == 'admin' || Auth::user()->role == 'super_admin'): ?>
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <!-- Manajemen Aspirasi -->
                    <a href="<?php echo e(route('aspirasi.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                        <div class="bg-blue-100 p-3 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="<?php echo e(route('article.main')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                        <div class="bg-purple-100 p-3 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <!-- Manajemen Acara -->
                    <a href="<?php echo e(route('acara.index')); ?>"
                        class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow flex items-center space-x-4">
                        <div class="bg-green-100 p-3 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                ...
                <?php $__currentLoopData = $recommendedArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recommendedArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                        <div class="h-48 bg-cover bg-center"
                            style="background-image: url('<?php echo e(asset('storage/' . $recommendedArticle->picture_article)); ?>')">
                        </div>
                        <div class="p-4">
                            <h4 class="font-semibold text-gray-800 mb-2"><?php echo e($recommendedArticle->title); ?></h4>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-4">
                            <form id="statusForm" method="POST" action="<?php echo e(route('rekap.event')); ?>">
                                <?php echo csrf_field(); ?>
