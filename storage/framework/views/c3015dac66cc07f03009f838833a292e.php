...
<div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/2">
                <div class="bg-white rounded-xl shadow-md overflow-hidden h-full">
                    ...
                    <div class="p-4 h-[calc(100%-56px)]">
                        <?php if($rekap->dokumen): ?>
                            <iframe src="<?php echo e(asset($rekap->dokumen)); ?>" class="w-full h-full min-h-[500px] border rounded-lg"></iframe>
                        <?php else: ?>
            ...
            <!-- Validation Form -->
            <div class="w-full lg:w-1/2">
                <form action="<?php echo e(route('rekap.validasi', $rekap->id)); ?>" method="POST" class="bg-white rounded-xl shadow-md overflow-hidden">
                    <?php echo csrf_field(); ?>
                    <?php if($rekap->id): ?>
                        ...
                        <?php if($errors->any()): ?>
                            <div class="rounded-md bg-red-50 p-4">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-red-800">Terdapat <?php echo e($errors->count()); ?> kesalahan dalam pengisian</h3>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="border-b pb-4">
                                ...
                                <div class="mt-2 grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($rekap->name); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-500">NIM</p>
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($rekap->nim); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="semester" name="semester" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                    <?php for($i = 1; $i <= 8; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($rekap->semester == $i ? 'selected' : (old('semester') == $i ? 'selected' : '')); ?>>
                            ...
                            <div>
                                ...
                                <input type="number" name="IPK" id="IPK" value="<?php echo e(old('IPK', $rekap->IPK)); ?>" 
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900"><?php echo e($rekap->kesulitan ?? '-'); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 text-right">
                        <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            <?php echo e($rekap->id ? 'Validasi IPK' : 'Simpan'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\UKM\formadiksi\koorprodi-web\koorprodi\resources\views/ipk/edit.blade.php ENDPATH**/ ?>