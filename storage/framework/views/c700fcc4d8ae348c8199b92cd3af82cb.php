...
<head>
    ...
    <style>
        ...
        .hero_area {
            position: relative;
            background: url('<?php echo e(asset('storage/' . $article->picture_article)); ?>') no-repeat center center;
...
<body>
    ...
    <div class="hero_area">
        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary btn-floating" style="position: fixed; bottom: 20px; right: 20px; z-index: 1000;">
...
<?php /**PATH D:\KULIAH\UKM\formadiksi\koorprodi-web\koorprodi\resources\views/article/show.blade.php ENDPATH**/ ?>