    ...
    <div class="" style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        <table class="" style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="padding: 5px;"><?php echo e(old('semester') ?? 1); ?></td>
            </tr>
        </table>
    </div>
    <?php if($errors->any()): ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MyBook Hype AMD\Documents\Forma\koorprodi\resources\views/ipk/main.blade.php ENDPATH**/ ?>