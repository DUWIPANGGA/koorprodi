  ...
  <div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
    ...
    <div class="white-button first-button scroll-to-section">
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(url('/dashboard')); ?>" class="fab fa-door">
                Dashboard
            </a>
        <?php else: ?>
...
</html><?php /**PATH D:\KULIAH\UKM\formadiksi\koorprodi-web\koorprodi\resources\views/Tentang.blade.php ENDPATH**/ ?>