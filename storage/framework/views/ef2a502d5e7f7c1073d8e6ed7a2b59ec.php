            ...
            <div class="flex flex-col lg:flex-row items-center justify-center text-center lg:text-left">
                <div class="lg:w-1/2 mb-10 lg:mb-0" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <?php if(Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="btn-primary px-8 py-3 rounded-lg bg-primary-500 text-white hover:bg-blue-700 transition duration-300 flex items-center justify-center text-lg">
                                    <i class="fas fa-home mr-2"></i> Dashboard
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn-primary px-8 py-3 rounded-lg bg-primary-500 text-white hover:bg-blue-700 transition duration-300 flex items-center justify-center text-lg">
                                    <i class="fas fa-sign-in-alt mr-2"></i> Login
                                </a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('registrasi')); ?>" class="btn-outline-primary px-8 py-3 rounded-lg text-primary-500 border border-primary-500 hover:bg-primary-500 hover:text-white transition duration-300 flex items-center justify-center text-lg">
                                        <i class="fas fa-user-plus mr-2"></i> Register
                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
                ...
                <div class="lg:w-1/2 lg:pl-12" data-aos="fade-left" data-aos-delay="400">
                    <img src="<?php echo e(asset('mascot.png')); ?>" alt="Mascot" class="w-full h-auto max-w-lg mx-auto">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="artikel" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden h-full flex flex-col transition-transform duration-300 hover:scale-105 hover:shadow-xl" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <img src="<?php echo e(asset('storage/' . $recommendedArticle->picture_article)); ?>" class="w-full h-48 object-cover" alt="<?php echo e($recommendedArticle->title); ?>">
                    <div class="p-6 flex flex-col flex-grow">
                        <h5 class="text-xl font-semibold mb-3 text-gray-900"><?php echo e($recommendedArticle->title); ?></h5>
                        <p class="text-gray-600 text-sm flex-grow"><?php echo Str::limit($recommendedArticle->content, 100); ?></p>
                    </div>
                    <div class="px-6 pb-6 pt-0 bg-transparent">
                        <a href="<?php echo e(route('article.show.detail', $recommendedArticle->id)); ?>" class="inline-flex items-center text-primary-500 hover:text-blue-700 font-medium">
            ...
            <div class="flex justify-center">
                <div class="w-full lg:w-3/4">
                    <div class="bg-white p-8 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form method="POST" action="<?php echo e(route('rumahaspirasi.kirim')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-6">
                                <label for="nama" class="block text-gray-700 text-sm font-bold mb-2">Nama</label>
                                <input type="text" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-primary-500 <?php $__errorArgs = ['nama'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-primary-500 <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="isi"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    <div class="flex items-center mb-6">
                        <img src="<?php echo e(asset('formadiksi.png')); ?>" alt="FORMADIKSI" class="h-16 mr-4">
