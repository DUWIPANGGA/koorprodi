                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('formadiksi.png') }}" alt="Chain App Dev" height="80px" width="80px">
                            {{-- <h4>FORUM MAHASISWA BIDIK MISIS</h4> --}}
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <section class="popupBody">
            ...
            <div class="social_login">
                ...
                <div class="action_btns">
                    <div class="one_half"><a href="{{ route('login') }}" id="" class="btn">Login</a></div>
                    <div class="one_half last"><a href="{{ route('registrasi') }}" id="" class="btn">Sign
                            up</a></div>
                </div>
            </div>
                        ...
                        <form method="POST" action="{{ route('rumahaspirasi.kirim') }}" class="w-full">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="nama" id="nama" placeholder="Nama kamu"
                                    class="form-control @error('nama') border-red-500 @enderror" maxlength="100"
                            ...
                            <div class="mb-2">
                                ...
                                <textarea name="isi" id="isi" placeholder="Masukan aspirasi kamu" rows="4"
                                    class="form-control @error('isi') border-red-500 @enderror" maxlength="1000"
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="footer-widget">
                        <h4>FORMADIKSI</h4>
                        <div class="logo">
                            <img src="{{ asset('formadiksi.png') }}" alt="">
                        </div>
                        <p>Tempat terbaik untuk berbagi informasi, pengalaman, dan tips sukses dalam menjalani kehidupan
