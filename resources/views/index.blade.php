    ...
    <section class="popupBody">
        ...
        <div class="social_login">
            ...
            <div class="action_btns">
                ...
                <div class="one_half last"><a href="{{ route('registrasi') }}" id="" class="btn">Sign up</a></div>
            </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="service-item first-service">
            <div class="icon"></div>
            <h4>{{ $recommendedArticle->title }}</h4>
            <p>{!! Str::limit($recommendedArticle->content, 100) !!}</p>
            <div class="text-button">
              <a href="{{route('article.show.detail', $recommendedArticle->id) }}">Read More <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
