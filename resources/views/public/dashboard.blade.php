    ...
    <div class="min-h-screen p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Anda berada di semester {{ $semester }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-start space-x-4">
                    <div
                        class="{{ Auth::user()->pelaporan_ipk == 1 ? 'bg-green-100' : 'bg-yellow-100' }} p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-8 w-8 {{ Auth::user()->pelaporan_ipk == 1 ? 'text-green-600' : 'text-yellow-600' }}"
